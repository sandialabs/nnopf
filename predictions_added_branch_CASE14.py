...
files = [
    'CASE14_branch/pglib_opf_case14_ieee_modified_branch_4_8.m',
    'CASE14_branch/pglib_opf_case14_ieee_modified_branch_6_8.m',
    'CASE14_branch/pglib_opf_case14_ieee_modified_branch_7_13.m',
    'CASE14_branch/pglib_opf_case14_ieee_modified_branch_10_11.m',
    'CASE14_branch/pglib_opf_case14_ieee_modified_branch_12_14.m'
]
...
model.load_state_dict(torch.load('trained_models/ffnn_pglib_opf_case14_ieee_best.pt')) 
model.eval()  
...
np.save('all_pg_MSE_array_14_Kplus1.npy', all_pg_MSE_array)
np.save('all_qg_MSE_array_14_Kplus1.npy', all_qg_MSE_array)
np.save('all_va_MSE_array_14_Kplus1.npy', all_va_MSE_array)
np.save('all_vm_MSE_array_14_Kplus1.npy', all_vm_MSE_array)