...
files = [
    "CASE14_bus/pglib_opf_case14_ieee_modified_bus_1.m",
    "CASE14_bus/pglib_opf_case14_ieee_modified_bus_2.m",
    "CASE14_bus/pglib_opf_case14_ieee_modified_bus_3.m",
    "CASE14_bus/pglib_opf_case14_ieee_modified_bus_6.m",
    "CASE14_bus/pglib_opf_case14_ieee_modified_bus_8.m",
]
...
np.save("all_pg_MSE_array_14_Gplus1.npy", all_pg_MSE_array)
np.save("all_qg_MSE_array_14_Gplus1.npy", all_qg_MSE_array)
np.save("all_va_MSE_array_14_Gplus1.npy", all_va_MSE_array)
np.save("all_vm_MSE_array_14_Gplus1.npy", all_vm_MSE_array)
