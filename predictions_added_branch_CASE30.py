...
files = [
    "branch/pglib_opf_case30_ieee_modified_branch_1_9.m",
    "branch/pglib_opf_case30_ieee_modified_branch_3_6.m",
    "branch/pglib_opf_case30_ieee_modified_branch_20_22.m",
    "branch/pglib_opf_case30_ieee_modified_branch_22_28.m",
]
...
np.save("all_pg_MSE_array_30_Kplus1.npy", all_pg_MSE_array)
np.save("all_qg_MSE_array_30_Kplus1.npy", all_qg_MSE_array)
np.save("all_va_MSE_array_30_Kplus1.npy", all_va_MSE_array)
np.save("all_vm_MSE_array_30_Kplus1.npy", all_vm_MSE_array)
